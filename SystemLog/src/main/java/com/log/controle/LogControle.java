...
public class LogControle {
	...
	@Autowired LogServico logServico;
	...
	public ResponseEntity<List<LogDto>> consultarLog(@RequestParam(value= "dtInsersaoInicio", required = false) String dtInsersaoInicio, 
	...
	public ResponseEntity<List<LogDto>> consultarLogLista(@RequestParam(value= "idDados", required = true) Long idDados) {
